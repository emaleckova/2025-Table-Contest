...
vegetation_countries <- c(unique(dat_vegetation$country), "Democratic Republic of the Congo") # Zaire was renamed in 1997
...
PlotHalfViolins <- function(target_country){
  p_halfv <- ggplot(dat_vegetation, aes(x = country, y = delta)) +
...
dat_vegetation |>
  ...
  mutate(country = case_when(
    country == "Zaire" ~ "Democratic Republic of the Congo", # change of name for Zaire
    TRUE ~ country
  )) |>
