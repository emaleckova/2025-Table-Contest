...
veg_summarized |> 
    ...
    mutate(plot_col = "plot") |> 
    gt() |>
    text_transform(locations = cells_body(columns = "plot_col"), fn = function(x){
        p_ls_countries$`Democratic Republic of the Congo` |> 
            ggplot_image(height = 100, aspect_ratio = 1)
    })
```
