...
for (cont in vegetation_continents) {
    # Countries with data on this continent
    target_country <- vegetation_sf_countries[vegetation_sf_countries$continent == cont & vegetation_sf_countries$name_en %in% vegetation_countries, ]$name_en

    ggplot() +
    geom_sf(data = vegetation_sf_continents[vegetation_sf_continents$continent == cont, ], fill = "white") +
    geom_sf(data = vegetation_sf_countries[vegetation_sf_countries$continent == cont & vegetation_sf_countries$name_en == target_country, ], fill = "blue") +
    theme_void()
}
```
